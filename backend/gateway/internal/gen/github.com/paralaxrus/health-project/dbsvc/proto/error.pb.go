...
func (x *ErrorMsg) GetDescription() string {
	if x != nil {
...
const file_error_proto_rawDesc = "" +
	"\n" +
	"\verror.proto\x12\bhealthdb\"@\n" +
	"\bErrorMsg\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescriptionB8Z6github.com/paralaxrus/health-project/dbsvc/proto;protob\x06proto3"
...
var file_error_proto_goTypes = []any{
	(*ErrorMsg)(nil), // 0: healthdb.ErrorMsg
}
